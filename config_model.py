...
class PluginSection(PluginConfigBase):
    ...
    config_version: str = Field(default="1.2.3", description="配置版本")
...
class SharingSettings(PluginConfigBase):
    ...
    douyin_video_max_bytes: int = Field(default=25_000_000, ge=1_000_000, le=80_000_000, description="允许转发的视频最大字节数")
